	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				col *= 1 - _Color * max(0,cos(i.objVertex.x * i.objVertex.z * _Frequency + _Time.x * _Speed) + _Bias/_Bias2);
				col *= 1 - _Color * max(0,cos(i.objVertex.z * i.objVertex.z * _Frequency + _Time.x * _Speed) + _Bias/_Bias2);
				return col;
			}
			ENDCG
		}
